...
$string['blockname'] = 'EF Cursus snelzoeken';
$string['loading'] = 'Laden...';
$string['pluginname'] = 'EF Cursus snelzoeken';
$string['pluginnameplural'] = 'Cursus snelzoek lijsten';
$string['efquicklist:use'] = 'Gebruik Cursus snelzoeklijst';
$string['efquicklist'] = 'Cursus snelzoek lijst';
$string['displaymode'] = 'Resultaat Zoekformat';
...
$string['efquicklist:myaddinstance'] = 'Voeg blok Cursus snelzoeken toe aan startpagina';
$string['efquicklist:addinstance'] = 'Voeg blok Cursus snelzoeken toe';
$string['privacy:metadata'] = 'Het blok Cursus snelzoeken slaat geen persoonlijke data op.';
