...
$string['quickcourselist:use'] = 'Gebruik Cursus snelzoeklijst';
$string['quickcourselist'] = 'Cursus snelzoek lijst';
...
$string['quickcourselist:addinstance'] = 'Voeg blok Cursus snelzoeken toe';
